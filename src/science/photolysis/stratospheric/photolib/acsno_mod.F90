...
!    This code is written to UMDP3 standards.
   ...
   CHARACTER(LEN=*), PARAMETER, PRIVATE :: ModuleName = 'ACSNO_MOD'
...
!     Band del(0-1)
      ...
      CHARACTER(LEN=*), PARAMETER :: RoutineName = 'ACSNO'
...
!          > 20 KM           < 84 degrees.
      IF ((p <= 50.0) .AND. (angle <= (84.0*pi_over_180))) THEN
