...
CONTAINS
   ...
   SUBROUTINE ukca_deriv_aero(nr_therm, n_be_calls, theta_field_size, &
                              rc, wdep, ddep, &
                              dj, k_dms, h2o, m, o2, &
                              dts, y, &
      ...
      INTEGER, INTENT(IN) :: n_be_calls       ! No. of diagnostics
...
! Species concentrations
      REAL, INTENT(IN OUT) :: y(theta_field_size, jpspec)
...
! Initialise sulphur oxidation fluxes
      ...
      DO n = 1, n_be_calls
         ...
         ! Iteration start
         DO i = 1, ukca_config%nit

            !
            !   This section written automatically by MECH9GEN from the file
            !   ukca_tropch3 with 129 equations and 46 species.
            !
            !          O(3P)        Y( 1)
            p(:) = &
               +(dj(:, 15)*y(:, 3)) &
