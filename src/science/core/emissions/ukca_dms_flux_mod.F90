...
! Description:
!
!   Module containing subroutine for calculating the sea-to-air flux of
!   DMS (as kg m-2 s-1 of sulphur) as a function of its concentration in
!   in seawater and windspeed.
!
! Method:
!
